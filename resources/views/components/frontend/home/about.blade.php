        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="about-images about-entrance about-entrance--media" data-about-entrance>
                    <img class="about-flask about-entrance-float"
                        src="{{asset('assets/images/flask.webp')}}"
                        alt="Laboratory flask">

                    <img class="about-main-img about-entrance-main"
                ...
                <div class="row about-entrance-item">
                    ...
                    <div class="col-sm-6">
                        <div class="about-feature">
                            <span class="about-feature-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M6 3.5A1.5 1.5 0 0 1 7.5 2h1A1.5 1.5 0 0 1 10 3.5v1A1.5 1.5 0 0 1 8.5 6v1H14a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5H2a.5.5 0 0 1-.5-.5v-2A.5.5 0 0 1 2 7h5.5V6A1.5 1.5 0 0 1 6 4.5v-1z"/>
                                </svg>
                            </span>
