...
@section('content')
    <div class="page-header mb-4">
        <h4 class="mb-1 font-weight-bold">Add Packing</h4>
        <p class="text-muted mb-0">Create a new packing with name and slug.</p>
    </div>
            ...
            <div class="card admin-card">
                <div class="card-body p-4">
                    <form action="{{ route('packings.store') }}" method="POST">
                        @csrf
                        @include('pages.backend.packings._form')

                        <div class="d-flex flex-wrap mt-4">
                            <button type="submit" class="btn btn-auth mr-2">Save Packing</button>
